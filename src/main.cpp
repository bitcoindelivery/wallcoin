...
uint256 hashGenesisBlock("0xf60a719d5ac67b732b00cbf4037ebe2d62afd29884923cdbc52535188fd0bfd8");
...
const string strMessageMagic = "WallCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // WallCoin: 1 days
static const int64 nTargetSpacing = 120; // WallCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal wallcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WallCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x686935fcb6d28cceb61c462de85c6c62d98fe97a40a7fa0b521484439bc66814");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1456478927; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 482715;

        if (fTestNet)
        {
            block.nTime    = 1456448035;
            block.nNonce   = 151485;
        }
